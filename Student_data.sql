...
select * from student;
SELECT * from STUDENT where branch ='AIML' or branch='IoT' or branch='DS';
SELECT * from STUDENT where branch in('CSE','AIML','DS');
select * from student where fee>=100000 and fee<=150000;
...
when 'AIML' then 'ARTIFICIAL INTILIGENCE'
else 'OTHER BRANCH'
