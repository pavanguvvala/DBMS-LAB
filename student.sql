...
select count(*) from student where BRANCH not in ('CSE','IT','EEE','DS');

select date_of_admission ,count(DATE_OF_ADMISSION)from student group by DATE_OF_ADMISSION order by count(DATE_OF_ADMISSION) desc;

select distinct branch,count(*) from student where branch is not null;

select college, branch , count(*) from student where branch='AIML' group by college,branch order by count(*) ;

select gender,count(*) from student where college='ACOE' group by gender;

select name,date_of_admission from student where college='ACET' and branch='IoT' order by DATE_OF_ADMISSION;

select id,max(fee) from student where fee is not null group by id order by max(fee) desc ;

select count(*) from student where email is null;

update student set email='dummy@gmail.com' where email is null;

select date_of_admission from student where college='ACOE' and branch='CSE' order by DATE_OF_ADMISSION desc;

select avg(age) from student;

select branch,count(*) from student where college='ACOE' group by branch order by count(*);

select count(*) from student where DATE_OF_ADMISSION >='2023-07-01' and DATE_OF_ADMISSION <='2023-12-31';

select name from student where age is null and email ='dummy@gmail.com';
