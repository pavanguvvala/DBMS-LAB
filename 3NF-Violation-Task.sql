...
ALTER TABLE employees DROP COLUMN project_name;

alter table EMPLOYEES add CONSTRAINT fk_dept FOREIGN KEY(client_ID) REFERENCES clients(client_ID);

alter table EMPLOYEES add CONSTRAINT fk_dept FOREIGN KEY(project_ID) REFERENCES projects(project_ID);
